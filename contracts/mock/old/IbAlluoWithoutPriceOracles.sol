...
import "./ILiquidityHandlerWithoutPriceOracles.sol";
...
contract IbAlluoWithoutPriceOracles is
    Initializable,
    PausableUpgradeable,
    ...
    // ERC2771ContextUpgradeable(0x86C80a8aa58e0A4fa09A69624c31Ab2a6CAD56b8) - injected in code directly
{
    ...
    function getBalance(address _address) public view returns (int256) {
        ...
        // Disabled for consistency with version of the contract deployed on mainnet and needed for tests
