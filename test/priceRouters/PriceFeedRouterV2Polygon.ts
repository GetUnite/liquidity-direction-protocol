...
import { ChainlinkFeedStrategy, ChainlinkFeedStrategyV2, CurveLpReferenceFeedStrategyV2, CurvePoolReferenceFeedStrategy, CurvePoolReferenceFeedStrategyV2, IERC20Metadata, IFeedStrategy, PriceFeedRouter, PriceFeedRouterV2, PriceFeedRouterV2__factory } from "../../typechain-types";

describe("Price Feed Router V2 (Polygon)", function () {
    type FiatRoute = {
        name: string,
        id: number;
        oracle: string,
