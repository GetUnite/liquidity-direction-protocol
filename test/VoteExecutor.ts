...
import { ICvxBaseRewardPool, IERC20, IUniversalCurveConvexStrategy, PseudoMultisigWallet, PseudoMultisigWallet__factory, VoteExecutor, VoteExecutorForTest, VoteExecutorForTest__factory, VoteExecutor__factory } from "../typechain";
